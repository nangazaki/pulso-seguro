<template>
  ...
  <main class="h-screen w-full p-8 overflow-auto">
    ...
    <span class="font-montserrat text-gray-400"
      >Dashboard / Pacientes / {{ pacient.usuario }}</span
    >
    <span class="font-montserrat text-xl text-cinza-1 mb-8 block">
      Perfil do Paciente
      <span class="font-medium"
        >{{ pacient.name }} {{ pacient.sobrenome }}</span
      >
    </span>

    <div class="w-full flex gap-8 my-8">
      <div>
        <span class="text-primaria-claro font-montserrat mb-4 block"
          >Sobre</span
        >
        <div
          class="w-full max-w-[320px] px-8 py-6 bg-white rounded-md card-shadow"
        >
          <div class="mb-6 flex items-center flex-col">
            <div class="w-32 h-32 relative mb-3 rounded-full overflow-hidden">
              <img
                :src="`http://localhost:8000/storage/${pacient.imagem}`"
                class="block h-full object-cover"
                alt="thumb"
              />
            </div>
            <span class="font-montserrat text-lg mb-0"
              >{{ pacient.name }} {{ pacient.sobrenome }}</span
            >
          </div>
          <div class="mb-6">
            <span class="font-montserrat text-cinza-3 uppercase text-sm mb-4"
            ...
            <div class="mt-2">
              <div class="flex items-center gap-2 mb-2">
                <div class="col-auto">
                  <div class="w-4">
                    <svg
                      ...
                      class="acorn-icons acorn-icons-phone text-primaria-claro"
                    >
                      <path
                ...
                <div class="text-cinza-1">{{ pacient.telefone }}</div>
              </div>
              <div class="flex items-center gap-2 mb-2">
                <div class="col-auto">
                  <div class="w-4">
                    <svg
                      ...
                      stroke-linecap="round"
                      stroke-linejoin="round"
                      class="acorn-icons acorn-icons-email text-primaria-claro"
                    >
                      <path
                ...
                <div class="text-cinza-1">{{ pacient.email }}</div>
              </div>
              <div class="flex items-center gap-2 mb-2">
                <div class="col-auto">
                  <div class="w-4">
                    <svg
                      ...
                      stroke-linecap="round"
                      stroke-linejoin="round"
                      class="acorn-icons acorn-icons-pin text-primaria-claro"
                    >
                      <path
                ...
                <div class="text-cinza-1">
                  {{ pacient.municipio }}, {{ pacient.bairro }}
                </div>
              </div>
            </div>
          </div>
          <div class="mb-6">
            <span class="font-montserrat text-cinza-3 uppercase text-sm"
              >Doctor responsável</span
            >
              ...
              <div class="col-auto">
                <div class="w-4">
                  <svg
                    ...
                    stroke-linecap="round"
                    stroke-linejoin="round"
                    class="acorn-icons acorn-icons-health text-primaria-claro"
                  >
                    <path
                      d="M9.5 3.00001V3.00001C9.83758 3.00001 10.0064 3.00001 10.1455 3.01964C11.0759 3.15098 11.7895 3.91236 11.8602 4.84939C11.8708 4.98944 11.8599 5.15788 11.838 5.49475L11.5634 9.72329C11.4072 12.1288 9.41057 14 7 14V14C4.58942 14 2.59278 12.1288 2.43658 9.72329L2.162 5.49475C2.14012 5.15788 2.12918 4.98944 2.13976 4.84939C2.21053 3.91236 2.92408 3.15098 3.85455 3.01964C3.99363 3.00001 4.16242 3.00001 4.5 3.00001V3.00001"
                    ></path>
                    <path
                      d="M7 14V14C7 14.93 7 15.395 7.10222 15.7765C7.37962 16.8117 8.18827 17.6204 9.22354 17.8978C9.60504 18 10.07 18 11 18H11.75C13.383 18 14.1995 18 14.8269 17.6906C15.4192 17.3985 15.8985 16.9192 16.1906 16.3269C16.5 15.6995 16.5 14.883 16.5 13.25L16.5 10.5"
                    ></path>
                    <path
                      d="M18 8.5C18 9.32842 17.3284 10 16.5 9.99999V9.99999C15.6716 9.99998 15 9.32842 15 8.49999V8.49999C15 7.67157 15.6716 7 16.5 7V7C17.3284 7 18 7.67157 18 8.5V8.5Z"
                    ></path>
      ...
      <div class="w-full">
        <div class="mb-10">
          <span class="text-primaria-claro font-montserrat mb-4 block"
            >Estado</span
          >
          <div class="w-full h-72 bg-white rounded-md card-shadow"></div>
        </div>
        <div class="flex gap-6 flex-nowrap overflow-x-scroll">
          <div
            class="w-[234.5px] h-full flex-shrink-0 whitespace-normal select-none px-1"
          >
            <div
              class="relative cursor-pointer card-shadow bg-white flex flex-col rounded-lg border border-white mb-5 hover:border-primaria-claro"
            >
              <span class="absolute top-6 right-4 z-10">
                <svg
                  ...
                  stroke-linecap="round"
                  stroke-linejoin="round"
                  class="acorn-icons acorn-icons-check text-primaria-claro"
                >
                  <path
                    d="M16 5L7.7051 14.2166C7.32183 14.6424 6.65982 14.6598 6.2547 14.2547L3 11"
                  ></path>
                </svg>
              </span>
              <div
                class="p-8 h-100 flex flex-col justify-between card-shadow items-center"
              >
                <div
                  class="w-16 h-16 rounded-full flex justify-center items-center border border-primaria-claro"
                >
                  <svg
                    text-primaria-clarog
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    height="20"
                    viewBox="0 0 20 20"
                ...
                <div
                  class="text-primaria-claro font-montserrat text-2xl font-light"
                >
                  37.2
                </div>
              </div>
              ...
              >
                ...
                >
                  <svg
                    ...
                    stroke-linecap="round"
                    stroke-linejoin="round"
                    class="acorn-icons acorn-icons-heart text-primaria-claro"
                  >
                    <path
              ...
              >
                ...
                >
                  <svg
                    ...
                    stroke-linecap="round"
                    stroke-linejoin="round"
                    class="acorn-icons acorn-icons-blood text-primaria-claro"
                  >
                    <ellipse
                      cx="6.49996"
                      cy="5.99999"
...
export default {
  ...
  mounted() {
    this.getPacient(this.$route.params.id);
  },
  methods: {
    getPacient() {
      api.get(`pacientes/${this.$route.params.id}`).then((res) => {
        return (this.pacient = res.data);
      });
    },
  },
