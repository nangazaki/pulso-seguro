<template>
    <tr class="border-b border-cinza-4">
        ...
        <td class="flex items-center py-4">
            <img class="inline-block h-12 w-12 rounded-full ring-2 ring-white" :src="paciente.img" alt="" />              
            <div class="px-4">
                <div>
                    <a href="#" class="text-cinza-1 font-bold">{{ paciente.nome }}</a>
                </div>
        ...
        <td class="py-3 px-2 text-cinza-2">{{ paciente.cargo }}</td>
