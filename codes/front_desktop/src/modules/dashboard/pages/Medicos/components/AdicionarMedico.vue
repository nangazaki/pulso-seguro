<template>
  <div
    :class="`${this.isVisible ? 'fixed w-full h-full bg-[#22222228]' : 'hidden'}`"
  >
    <form
      type="post"
    ...
    >
      <div class="flex items-center justify-between mb-3">
        <h4 class="text-xl">Adicionar Medico</h4>
        <button
          class="
            bg-cinza-5
            text-cinza-3
