...
export default {
  components: { Form, Field, ErrorMessage, ConfirmDoctor, DefaultLayout },
  setup() {
    ...
    async function onSubmit(values) {
      DoctorStore.AdicionarDoctor(values, state.imagem);

      DoctorStore.setModalConfirm(true);
      setTimeout(fecharMenu, 3000);
    }
    ...
    return { schema, state, previewImage, onSubmit };
  },
};
</script>
  ...
  <DefaultLayout>
    <div class="container mx-auto mb-20">
      ...
      <header class="p-8">
        ...
        <h2 class="text-2xl font-light">Olá, Nome do Usuário!</h2>
      </header>
