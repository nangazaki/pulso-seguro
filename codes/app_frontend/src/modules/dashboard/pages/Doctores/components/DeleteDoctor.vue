...
export default {
  setup() {
    ...
    const visibility = computed(() => DoctorStore.modalDelete.visible);

    function fecharModal() {
      DoctorStore.cancelDoctorDelete();
    }
    ...
    return { visibility, doctor, fecharModal, deleteDoctor };
  },
};
</script>
    ...
    >
      <div class="">
        ...
        <div class="p-3 mt-2 text-center space-x-4 md:block">
          ...
          <button
            @click="deleteDoctor"
            class="bg-red-500 border border-red-500 px-6 py-2 text-md shadow-sm font-medium tracking-wider text-white rounded-md hover:shadow-lg hover:bg-red-600"
          >
            Eliminar
          </button>
        </div>
